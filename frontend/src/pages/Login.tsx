        ...
        <div className="w-full max-w-md">
          ...
          <Card className="card-elevated animate-fade-up">
            <CardHeader className="text-center pb-8">
              ...
              <p className="text-muted-foreground">Sign in to your Smart Classroom account</p>
            </CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* User Type */}
                <div className="space-y-2">
                  <Label htmlFor="userType" className="font-medium">User Type</Label>
          ...
          <Card className="mt-6 card-flat">
            ...
            <CardContent className="pt-0">
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <p><strong>Faculty:</strong> faculty@demo.com / faculty123</p>
