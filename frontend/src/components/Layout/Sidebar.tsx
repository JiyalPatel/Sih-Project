...
const Sidebar = ({ userRole = "faculty" }: SidebarProps) => {
  ...
  const adminNavItems = [
    { icon: CheckCircle, label: "Approval Requests", path: "/dashboard/approvals" },
    { icon: Filter, label: "Filters", path: "/dashboard/filters" },
    { icon: Eye, label: "View Timetable", path: "/dashboard/view-timetable" },
  ];
          ...
          <div className="flex items-center justify-between">
            {!isCollapsed && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-semibold text-sidebar-foreground">Smart Classroom</h2>
